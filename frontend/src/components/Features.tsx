'use client'
import dashboardScreenshot from "./../../public/dashboard-screenshot.jpg";
import playgroundScreenshot from "./../../public/playground-screenshot.jpg";
import chatScreenshot from "./../../public/chat-screenshot.jpg";
